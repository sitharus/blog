...
CREATE TABLE IF NOT EXISTS templates_history (LIKE templates);

CREATE TRIGGER templates_versioning_trigger
BEFORE INSERT OR UPDATE OR DELETE ON templates
FOR EACH ROW EXECUTE PROCEDURE versioning(
  'sys_period', 'templates_history', true
);
